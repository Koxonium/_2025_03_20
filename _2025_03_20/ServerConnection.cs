...
namespace _2025_03_20
{
    public class ServerConnection
    {
        ...
        public async Task<bool> CreatePerson(string name, string age)
        {
        ...
        public async Task<List<string>> PersonNames()
        {
            List<string> all = new List<string>();
        ...
        public async Task<List<string>> PersonAges()
        {
            List<string> all = new List<string>();
            ...
            try
            {
                ...
                response.EnsureSuccessStatusCode();
                string result = await response.Content.ReadAsStringAsync();
                all = JsonConvert.DeserializeObject<List<JsonData>>(result).Select(item => item.age).ToList();
            }
            catch (Exception e)
            {
                MessageBox.Show(e.Message);
